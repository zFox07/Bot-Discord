...
//envia msg no pv da pessoa----------------|
        ...
        if(!usu.bannable) return message.channel.send(`:x: | ${message.author} Eu não tenho permissão para banir este corno!`);

        const edu = new Discord.MessageEmbed()
        .setTitle(`🔨 Banimento!`)
